...
Auto generated DreemGL API documentation can be accessed at [/apps/docs](http://localhost:2000/apps/docs).  

### HTML Docs

To generate HTML documentaion first run the documentation builder:

    ./resources/bin/buiddocs

And then the documentationw will be visible here [/docs/api/index.html](http://localhost:2000/docs/api/index.html)
