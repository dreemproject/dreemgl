					...
					cadgrid({
						...
						view({flex:1, alignitems:"center", justifycontent:"space-around", bgolor:"red", margintop:100},
							view({flexdirection:"column"},
								label({text:"Radio Buttons - default group", marginbottom:20}),
								radiobutton({
									marginbottom:10,
							...
							view({flexdirection:"column"},
								label({text:"Radio Buttons - custom group", marginbottom:20}),
								radiobutton({
									marginbottom:10,
									group:"other",
									icon:"star-o",
									onselected:function(ev,v,o) { o.icon = v ? "star" : "star-o" },
