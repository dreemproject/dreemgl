		...
		return [
			screen(
				...
				cadgrid({
					...
					view({height:360, width:365, bgcolor:vec4(0.4404359459877014,0.7965562343597412,0.8361037373542786,1), position:'absolute', x:761.0000610351562, y:53.999969482421875},view({height:60, width:60, bgcolor:vec4(0,0.17658153176307678,0.501960813999176,1), position:'absolute', x:110.00006103515625, y:40.99998474121094}),view({height:60, width:63, bgcolor:'purple', position:'absolute', x:67, y:173.00010681152344}),icon({fgcolor:vec4(0.970705509185791,0.9806346297264099,0.9984665513038635,1), icon:'flask', position:'absolute', x:131.9998779296875, y:24.999984741210938, fontsize:80}))
				),
				toolkit()
