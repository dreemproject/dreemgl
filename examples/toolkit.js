		...
		return [
			screen(
				...
				cadgrid({
					...
					view({height:257, width:451, bgcolor:vec4(0.12939296662807465,0.4936515688896179,0.6595012545585632,1), position:'absolute', x:703.146728515625, y:446.25152587890625, rotate:vec3(0,0,10)}),
					...
					view({height:60, width:60, bgcolor:'purple', position:'absolute', x:455, y:660.9999389648438})
				),
