			...
			return [
				screen(
					...
					cadgrid({
						...
						view({height:174,width:746,pickalpha:-1,bgcolor:'white',position:"absolute",x:128,y:620.9999389648438},icon({fgcolor:'#e22',bgcolor:'transparent',pickalpha:-1,icon:"heart",fontsize:80,position:"absolute",x:237.99993896484375,y:47.000091552734375}))
					),
					toolkit({
						position:"absolute",
						visible:true,
