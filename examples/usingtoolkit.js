			...
			return [
				screen(
					...
					cadgrid({
						...
						label({tooltarget:false,name:"reminder",visible:false,fontsize:44,pickalpha:-1,bgcolor:'transparent',fgcolor:'pink',text:"CTRL-SHIFT-T to pop up the toolkit!",position:"absolute",x:71,y:55.99999237060547}),
