			...
			return [
				screen(
					...
					cadgrid({
						...
						label({name:"reminder",tooltarget:false,visible:false,oninit:function(){this.visible=!this.find("toolkit").visible},fontsize:44,pickalpha:-1,bgcolor:'transparent',fgcolor:'pink',text:"CTRL-SHIFT-T to pop up the toolkit!",position:"absolute",x:71,y:55.99999237060547}),
						...
						icon({fgcolor:'palegreen',bgcolor:'transparent',pickalpha:-1,icon:"gear",fontsize:80,position:"absolute",x:458,y:276.9999694824219})
					),
					toolkit({
						name:"toolkit",
						position:"absolute",
						visible:true,
						onvisible:function(ev,v,o) { o.find("reminder").visible=!v },
						x:890,
						y:30,
						width:300,
						height:700
