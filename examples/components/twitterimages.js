...
// The server uses twitterlib to retrieve twitter images from the SF area.
// You can either use the streaming interface (using their 1% firehose), or
// retrieve recent images from the area.
//
// Live reloading causes some issues with the connection between the client
// and server. I found it best to restart the server whenever the code is
// modified.
//
