        ...
        return cadgrid({bgcolor:"#000030", majorline: "#003040", minorline: "#002030" },
            view({bg:false, flexdirection:"column", flex:1, justifycontent:"center" },
                view({bg:false, flexdirection:"row", flex:1, justifycontent:"center" },
                    view({bgcolor:vec4(1,1,1,0.15),padding:40,borderradius:50,  flexdirection:"column" ,alignitems:"center", justifycontent:"center" },
                        ...
                        view({flexdirection:"row", flex:1}, label({text:'array',  paddingright:15}), label({text:this.array,  fgcolor:'#0198E1'})),
                        view({flexdirection:"row", flex:1}, label({text:'string', paddingright:15}), label({text:this.string, fgcolor:'#6ADA7A'})),
                        view({flexdirection:"row", flex:1}, label({text:'object', paddingright:15}), label({text:JSON.stringify(this.object), fgcolor:'#ffee14'}))
                    )
                )
            )
        );
