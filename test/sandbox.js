		...
		return [
			screen(
				...
				cadgrid({
					...
					checkbox({tooldragroot:true, toolresize:false, fontsize:24, pickalpha:-1, fgcolor:"pink", position:"absolute", x:492, y:227})
				),
				toolkit({
					position:"absolute", 
					visible:true, 
