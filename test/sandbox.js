		...
		return [
			screen(
				...
				cadgrid({
					...
					label({fontsize:144, pickalpha:-1, bgcolor:"transparent", fgcolor:vec4(0.5647059082984924,0.6037501096725464,0.9333333373069763,1), text:"Change Text", position:"absolute", x:152.7449951171875, y:95.0771484375, rotate:vec3(0,0,0.21000009775161743)})
				),
				toolkit({
					position:"absolute", 
					visible:true, 
