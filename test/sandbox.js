		...
		return [
			screen(
				...
				cadgrid({
					...
					view({height:181, width:779, pickalpha:-1, bgcolor:vec4(0,0.2716766893863678,0.501960813999176,1), position:"absolute", x:47.00004577636719, y:525.9999389648438, alignitems:"center", justifycontent:"center"},view({height:70, width:80, pickalpha:-1, bgcolor:"purple", position:"relative"}),icon({fgcolor:"cornflower", pickalpha:-1, icon:"flask", fontsize:80, position:"relative"}))
				),
				toolkit({
					position:"absolute", 
					visible:true, 
