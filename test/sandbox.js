		...
		return [
			screen(
				...
				cadgrid({
					...
					button({tooldragroot:true, fontsize:24, pickalpha:-1, fgcolor:"red", label:"Press Me!", position:"absolute", x:471.00006103515625, y:294.9999694824219})
				),
				toolkit({
					position:"absolute", 
					visible:true, 
