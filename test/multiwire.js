define.class("$server/composition",function($server$,service,$ui$,screen,$flow$displays$,debug,outputs){
  ...
  this.render=function(){
    return [
      ...
      debug({name:'default',clearcolor:'#484230',flowdata:{x:484,y:159,screen:true},array:wire("[this.rpc.a.number,this.rpc.a.vec2,this.rpc.b.vec4]"),object:wire("{\"b.object\":this.rpc.b.object,\"a.object\":this.rpc.a.object}")}),
