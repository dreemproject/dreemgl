...
(function define_module(){
	...
	function define(factory, package){
		if(typeof(package) !== "undefined"){ // precompiled version
...
*/
	...
	function define_light(){
		...
		define.define = function(factory) {
			...
			console.log("module is", module.filename, __filename)
			...
			function noderequirewrapper(iname) {
				...
				var full_name = name;
				console.log("time to require", name)
				...
				full_name += '.js'
				console.log("time to require full", full_name)
			...
			var ret;
			try{
				ret = factory.call(module.exports, noderequirewrapper, module.exports, module)
			}
			finally{
				define.local_require_stack.pop()
			}
	...
	else if(define.$environment === 'nodejs') define_light() //xxx switch this
