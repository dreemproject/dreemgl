...
define.class('$system/platform/base/midi', function (require, exports){
	...
	this.Input = define.class('$base/node', function midiInput(){
	...
	this.Output = define.class('$base/node', function midiOutput(){
