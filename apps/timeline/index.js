	...
	this.render = function() {
		return [
			service({
				...
				loadevents: function() {
					var fs = require('fs')
					var flickrdata1 = JSON.parse(fs.readFileSync('compositions/timeline/data/flickr1.json', 'utf8'))
					var flickrdata2 = JSON.parse(fs.readFileSync('compositions/timeline/data/flickr2.json', 'utf8'))
					var flickrdata3 = JSON.parse(fs.readFileSync('compositions/timeline/data/flickr3.json', 'utf8'))
					var foursquaredata = JSON.parse(fs.readFileSync('compositions/timeline/data/foursquare.json', 'utf8'))
