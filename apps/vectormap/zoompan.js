define.class('$server/composition', function vectormap(require,  $server$, fileio,$ui$, numberbox, gbutton, menubar, label, screen, view, foldcontainer, speakergrid,checkbox, icon, $widgets$, colorpicker,  jsviewer, radiogroup, $3d$, ballrotate, $$, urlfetch, geo, map){
	...
	this.renderbuttongrid = function(z){
				...
				for (var x = 0;x<10;x+=2){
					var t = x + " " + y
					R.push(gbutton({xtarget:x, ytarget:y, ztarget:z, text:t,click:function(){this.rpc.index.moveTo(this.xtarget,this.ytarget,this.ztarget);}, margin:2}))
				}
