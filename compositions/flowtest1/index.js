define.class("$server/composition",function($server$, service, $ui$, screen, view, $flow$services$, map, omdb, webrequest, $flow$controllers$, xypad, knob, gamepad, keyboard, dpad, $flow$displays$, labtext, inputs, outputs, album) {
	this.render = function() {
		return [
			...
			album({name:"album0", flowdata:{x:696, y:33}, images:wire("this.rpc.omdb0.results")})
		]
	}
